...
@application.route('/submit_request', methods=['POST'])
def submit_request():
...
@application.route('/get_payment_proposal/<string:proposal_id>', methods=['GET'])
...
@application.route('/submit_payment_approval', methods=['POST'])
...
@application.route('/payment_execution_result/<string:proposal_id>', methods=['GET'])
